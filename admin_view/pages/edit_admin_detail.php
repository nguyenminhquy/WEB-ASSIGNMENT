...
if (isset($_GET['id']) && is_numeric($_GET['id'])) {
    ...
    if ($result->num_rows == 1) {
        ...
        echo "Không tìm thấy admin với ID này!";
        exit();
    }
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $stmt_update->bind_param("sssssi", $username, $email, $address, $phone, $dob, $admin_id);

        if ($stmt_update->execute()) {
            $_SESSION['success_message'] = "Thông tin admin đã được cập nhật thành công!";
...
<?php include './sidebar.php'; ?>
    ...
    <h1 class="text-center">Chỉnh Sửa Thông Tin Admin</h1>
    
    <?php if (isset($error_message)): ?>
        <div class="alert alert-danger"><?= $error_message; ?></div>
    <?php endif; ?>

    <form action="edit_admin_detail.php?id=<?= $admin['id']; ?>" method="POST">
        ...
        <a href="admin_list.php" class="btn btn-secondary">Hủy</a>
    </form>
</div>

<?php if (isset($_SESSION['success_message'])): ?>
    <div id="successModal" class="modal" tabindex="-1" role="dialog" aria-labelledby="successModalLabel" aria-hidden="true">
