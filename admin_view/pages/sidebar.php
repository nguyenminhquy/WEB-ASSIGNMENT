    ...
    <ul class="list-group">
        <li class="list-group-item">
            ...
            <ul class="collapse list-unstyled" id="productMenu">
                <li><a href="./user_list.php">Xem danh sách khách hàng</a></li>
                <li><a href="./admin_list.php">Xem danh sách nhân viên</a></li>
                <li><a href="./delete_admin.php">Xóa nhân viên</a></li>
                <li><a href="./edit_admin.php">Chỉnh sửa thông tin nhân viên</a></li>
            </ul>
        </li>
